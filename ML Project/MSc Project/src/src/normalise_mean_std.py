...
res_df.to_csv(os.path.join(FILTERED_PATH, "similarity.csv"))
...
pd.Series(mean_for_normalise).to_csv(os.path.join(FILTERED_PATH, "mean.csv"))
pd.Series(std_for_normalise).to_csv(os.path.join(FILTERED_PATH, "std.csv"))
np.save(os.path.join(FILTERED_PATH, "mean.npy"), mean_for_normalise)
np.save(os.path.join(FILTERED_PATH, "std.npy"), std_for_normalise)
