...
loss_values, output = train_model(model, citation_network, tensor_node_features, optimizer_fn, loss_fn, epochs=100)
torch.save(output, 'result_undirected.pt')
...
plt.savefig('loss_trends_undirected.png')
np.savetxt('loss_values_undirected.csv', loss_values, delimiter=',')
